...
public enum MemberErrorMsg {
    ...
    MEMBER_NAME_NULL_ERROR_MESSAGE("M301","이름은 NULL일 수 없습니다."),
    MEMBER_NAME_LENGTH_ERROR_MESSAGE("M302","이름은 1-5자여야 합니다."),

    MEMBER_PHONE_NUM_LENGTH_ERROR_MESSAGE("M401","휴대폰번호는 11자리여야 합니다."),
    MEMBER_PHONE_NUM_ONLY_NUMBER_REGEX_ERROR_MESSAGE("M402","휴대폰번호는 숫자로만 이루어져야 합니다."),
