...
public class MemberTest {
    ...
    public void createErrorIdLength(String 아이디_자릿수){
    ...
    public void createErrorIdRegex(String 아이디_유효문자){
    ...
    public void createErrorId(String 아이디_자릿수_유효문자){
    ...
    public void createErrorPassword(String 비밀번호_자릿수){
    ...
    public void createErrorName(String 이름_자릿수){
    ...
    public void createErrorPhoneNumLength(String 연락처_자릿수){
    ...
    public void createErrorPhoneNum(String 예외_연락처){
